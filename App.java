...
public class App {
    ...
    private static final String USERNAME = "Aurel";
    private static final String PASSWORD = "Rahma123";
    private static final String CAPTCHA = "Zami";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Kode Captcha : Zami");
